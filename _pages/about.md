...
I am a PhD candidate in the Electrical and Computer Engineering department at the University of Texas at San Antonio (UTSA). Currently, I am working as a graduate research assistant (GRA) in the IoT Security Lab, UTSA under the supervision of Dr. Qian Chen for around 3.5 years. My major research concentration is to design AI (ML/DL) models for developing next generation cyber defense tools considering human factors (Impulsiveness and risk-taking behavior).
